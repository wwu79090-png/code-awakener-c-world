...
const renderQualitySelectBlock = html.match(/<select id="renderQualitySelect">[\s\S]*?<\/select>/)?.[0] || "";
assert(renderQualitySelectBlock.includes('value="high"') && renderQualitySelectBlock.includes('value="low"'), "stable render-quality selector should expose high and low");
assert(!renderQualitySelectBlock.includes('value="medium"'), "stable render-quality selector should remove the flickering medium option");
