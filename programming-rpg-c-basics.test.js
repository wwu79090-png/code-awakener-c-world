...
assert(/bindFastTouchAction\(dom\.worldAdvanceButton[\s\S]{0,260}compileAndAdvanceWorld\(\)/m.test(html), "compile/advance button should be wired to the tutorial-aware compile logic");
...
assert(/bindFastTouchAction\(dom\.worldAdvanceButton[\s\S]*compileAndAdvanceWorld/m.test(html), "compile button should support touchstart and run the tutorial compiler");
